...
import RoomVirtualTour from "../360Previewer/Roomvirtualtour";
  ...
  return (
    <div className="min-h-screen" style={{ background: "#F7F9FB", fontFamily: "'Inter', sans-serif" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-5">
        ...
        <button
          onClick={() => navigate(`/search-results?page=${page}`)}
        ...
        <HotelGallery gallery={gallery} name={name} hotel={hotel} />

        {/* <RoomVirtualTour hotelId={hotel.id} /> */}
